                ...
                <td className="px-6 py-4">
                    <div className="flex space-x-1">
                        ...
                        <ConfirmationDeleteModal
                            id={id}
                            url={`/dashboard/agenda/delete/${id}`}
                            name={nama}
                            openModal={openModal}
...
AgendaTable.Header = Header;
AgendaTable.Body = Body;
AgendaTable.NotFound = NotFound;
