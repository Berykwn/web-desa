...
const TambahBarangMasuk = ({ pages, auth, errors, allBarang }) => {
    ...
    const handleSubmit = (e) => {
        ...
        formData.append("jumlah_masuk", formValues.jumlah_masuk);
        formData.append("keterangan", formValues.keterangan);

        router.post("/dashboard/inventaris/store/barangMasuk", formData);
    };
        ...
        <AdminLayout pages={pages} auth={auth}>
            <section className="bg-white rounded-md shadow-md px-6 pt-2 pb-4">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-4">
                        <InputLabel htmlFor="jumlah_masuk" value="Jumlah Masuk" />
                        <TextInput
                            id="jumlah_masuk"
                            type="text"
                            name="jumlah_masuk"
                            value={formValues.jumlah_masuk}
                            onChange={handleChange}
                            className="mt-1 block w-full"
                        />
                        {errors.jumlah_masuk && <InputError message={errors.jumlah_masuk} />}
                    </div>
